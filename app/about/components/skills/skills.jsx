...
const skillCategories = {
	web: {
		...
		tools: ["Visual Studio Code", "PyCharm", "Git", "Github", "Gitlab", "Figma", "Vite", "Docker", "Kubernetes", "Google Cloud", "Postman"],
	},
	api: {
		...
		tools: ["Postman", "Docker", "Kubernetes", "Swagger", "Git", "Github", "Google Cloud", "AWS", "Redis",
			"RabbitMQ", "gRPC", "PostGIS", "AWS EC2", "AWS S3", "GCP", "Elastic Search",
			"Circle CI", "Sentry", "Pytest", "Jenkins", "Github Actions", "Jira", "Trello", "Nginx","Gunicorn"],
	},
	ai: {
		title: "Automation & Data Engineering",
		icon: ActivityIcon,
		description: "Automating processes and large dataset processing",
		languages: [
			"Python",
			"Scikit-learn",
			"Pandas",
...
export function SkillCard({ skill, isSelected, onClick }) {
