...
const experiences = [
	{
		...
		endDate: "August 2018",
		company: "BS Software Engeering",
		position: "The University of Lahore",
		location: "Lahore Pakistan",
		description:
			"Developed a strong foundation in programming, data structures, algorithms, and full-stack web development. Gained hands-on experience with technologies like Python, JavaScript, React, and Django. Participated in team-based projects using Git and Agile methodologies, and built web applications integrating RESTful APIs and relational databases.",
		skills: ["Software Design", "Requirement Engineering", "Algorithms", "Data Structures", "Project Management"],
	},

	{
		...
		endDate: "Present",
		company: "MS Research in Computer and System Engeering",
		position: "TU Ilmenau",
		location: "Ilmenau, Germany",
		description:
			"Focused on advanced topics in systems engineering, data processing, and intelligent computing. Gained experience in AI, machine learning, and optimization techniques applied to real-world problems. Worked on research-driven projects involving system modeling, automation, and performance analysis. Strengthened skills in Python, FastAPI, Docker, and modern DevOps tools.",
		skills: ["Computer Science", "R&D", "System Design", ],
	},
];
